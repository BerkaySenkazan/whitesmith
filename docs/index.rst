...
.. code-block:: bash
    ...
    fastapi-mvc available under: http://whitesmith.192.168.49.2.nip.io/
...
.. code-block:: bash
    ...
    ...
    Kubernetes cluster ready
    FastAPI available under: http://whitesmith.192.168.49.2.nip.io/
    You can delete dev-env by issuing: make clean
    vagrant@ubuntu-focal:/syncd$ kubectl get all -n whitesmith
    NAME                        READY   STATUS    RESTARTS   AGE
    pod/whitesmith-649966bb7f-r694l   1/1     Running   0          114s

    NAME           TYPE        CLUSTER-IP    EXTERNAL-IP   PORT(S)    AGE
    service/whitesmith   ClusterIP   10.97.16.46   <none>        8000/TCP   114s

    NAME                   READY   UP-TO-DATE   AVAILABLE   AGE
    deployment.apps/whitesmith   1/1     1            1           114s

    NAME                              DESIRED   CURRENT   READY   AGE
    replicaset.apps/whitesmith-649966bb7f   1         1         1       114s
    vagrant@ubuntu-focal:/syncd$ curl http://whitesmith.192.168.49.2.nip.io/api/ready
    {"status":"ok"}
Documentation
-------------
